    ...
    >
      ...
      <div className="relative mx-auto grid max-w-7xl gap-12 md:grid-cols-[minmax(0,0.88fr)_minmax(0,1.12fr)] md:items-stretch">
        ...
        <div className="flex flex-col justify-center">
          ...
          <h2
            id="project-heading"
            className="font-display text-4xl font-black leading-[0.94] text-[var(--ipp-coral)] md:text-5xl lg:text-6xl"
          >
            Inglés para la paz desde la lectura, la conversación y el territorio.
          </h2>

          <p className="mt-7 max-w-2xl text-lg font-semibold leading-relaxed text-[var(--ipp-plum)]/80 md:text-2xl">
            En Inglés Pa&apos; la Paz creamos experiencias de aprendizaje donde el inglés emerge
            desde la lectura, la conversación y la creación colectiva. Usamos relatos, preguntas,
            recursos emocionales y actividades artísticas para que niñas, niños y comunidades vivan
            el inglés como una herramienta cercana para expresar lo que son, lo que sienten y lo
            que imaginan.
          </p>
